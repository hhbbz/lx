            ...
            success : function(data) {
                ...
                for(var i = 0; i < data.size; i++){
                    if(i%3==0){
                        ...
                        $("#product"+i).append("<div><a href="+"show/"+data.content[i].id+"><img src="+"/lx/resources/file/product/"+data.content[i].picture+"  height="+154+" border="+0+" width="+169+" /></a><div style='margin-left:52px' ><a href="+"show/"+data.content[i].id+">"+data.content[i].name+"</a></div></div>")
                }
            },
            error : function() {
                alert("请求失败")
