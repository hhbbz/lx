        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>订单管理<a class="btn btn-sm btn-primary-outline pull-right" href="${pageContext.request.contextPath}/admin/orders/addUI" ><i class="icon-plus"></i>添加</a>
                    </div>
            ...
            "aoColumns":
                    [
                        ...
                        },
                        {
                            ...
                            "fnRender": function(obj) {
                                var id=obj.aData.id;
                                var render=  '<a class="edit-row" target="_blank" href="${pageContext.request.contextPath}/admin/orders/show/'+id+'"><i class="icon-pencil"></i>查看</a>';
                                render+= '&nbsp;/&nbsp;';
...
// 3个参数的名字可以随便命名,但必须是3个参数,少一个都不行
        ...
        $('#datatable-editable').on('click', 'a.delete-row', function (e) {
            ...
            $.post("${pageContext.request.contextPath}/admin/orders/delete/"+id, function(result){
                if(result.success){
