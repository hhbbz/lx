        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>产品管理<a class="btn btn-sm btn-primary-outline pull-right" href="${pageContext.request.contextPath}/admin/product/addUI" ><i class="icon-plus"></i>添加</a>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var oTable= $("#datatable-editable").dataTable({
            ...
            "sAjaxSource": "${pageContext.request.contextPath}/admin/product/dataTable",//这个是请求的地址
            ...
            "aoColumns":
                    [
                        ...
                        { "mData": "productType.name", 'sClass':'center'},
